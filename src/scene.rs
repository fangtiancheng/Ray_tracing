use crate::{aabb::*,vec3::*,hit::*,material::*,ray::*,texture::*,sphere::*,utility::*,camera::*};
...
pub fn two_spheres() -> HittableList{
    ...
    objects.objects.push(Box::new(Sphere::new(Vec3::new(0.0,-10.0,0.0),10.0,Arc::new(Lambertian::new(checker.clone())))));
    objects.objects.push(Box::new(Sphere::new(Vec3::new(0.0,10.0,0.0),10.0,Arc::new(Lambertian::new(checker.clone())))));
    return objects;
}